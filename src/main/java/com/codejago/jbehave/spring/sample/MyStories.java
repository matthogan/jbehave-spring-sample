package com.codejago.jbehave.spring.sample;
...
import com.codejago.jbehave.spring.sample.steps.MySteps;
...
public class MyStories extends JUnitStories {
    ...
    public InjectableStepsFactory stepsFactory() {
        String path = "com.codejago.jbehave.spring.sample".replaceAll("\\.", "/");
